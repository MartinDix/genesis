...
!	Data arrays
	...
	real,dimension(:,:),allocatable			:: int1
	real,dimension(:,:),allocatable			:: int2
	real,dimension(:,:),allocatable			:: int3
	real,dimension(:,:),allocatable			:: int4
	real,dimension(:,:),allocatable			:: int5
	real,dimension(:,:),allocatable			:: int6
	real,dimension(:,:),allocatable			:: int7                   ! vjb 2.3
